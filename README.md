...
**Anti-phish zone**: The NPUB's most statistically anomalous section (lowest
Shannon entropy across multiple window sizes). This is discovered, not
...
│   ├── outlier_scanner.py      # Multi-scale z-score scanner
